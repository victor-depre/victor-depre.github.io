...
The balance of trade in goods and services is the difference between exports of goods and services and imports of goods and services, expressed in dollars. A positive balance indicates that exports exceed imports in value (trade surplus). A negative balance, on the contrary, indicates that imports exceed exports in value (trade deficit). The statistics relate this balance to the size of economic activity (GDP). We can see on the graph below that the trade balance reached its maximum in 2008 before the crisis. The crisis has had an important impact on the country's exportations since 2008 : exports have almost only fallen except in 2011 and 2012.
...
It can be seen from the graph below that overall Norway has very high scores, especially with regard to the integrity of the government. Nevertheless the greatest impediment to greater economic freedom in Norway is too much government spending. Reducing it will be difficult, however, because a large part of the economy and an even larger percentage of the government’s budget are structured around revenue from Equinor, the state-owned oil, gas, and wind-energy company.
...
Relative to other high-income countries, Norway performs extremely well across various indicators of resident's well-being. Life expectancy at birth has increased by two years since 2005, and average life expectancy is now two years higher than the average for OECD countries. This position is in contrast to the United States, which has a life expectancy not as good as Norway and that's the reason why Norway is above the United States or countries like Finland or Germany. On this graph we can also see that well-being in China is rather low compared to other countries, but this is still correct compared to countries like South Sudan (country where well-being indicators are the lowest in the world).
...
HWE <- sqs_spi_data(country = c("AUS", "DNK", "NOR", "NLD", "DEU", "ZWE", "SWE", "ESP", "FRA"), 
                       year = c("2014","2015","2016", "2017", "2018", "2019"), 
                       indicators = "HWE")
...
The graph shows that Norway is the best country having regard to political rights. Germany and France are just behind and countries like afghanistan or especially South Korea are still far behind.
...
Energy-related CO2 emissions in Norway are very low in comparisson to other countries. Because the energies used in the country are essentially renewable energies like hydropower. And we can see on the graph below that the majority of the countries are reducing their greenhouse gas emissions which is a great thing for the future.
